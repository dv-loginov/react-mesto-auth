          ...
          <section>
            <div className="profile">
              <button type='button' className="profile__avatar-edit">
                <img src="<%=require('./images/cap.jpg')%>" alt="Аватар" className="profile__avatar" />
              </button>
        ...
        <div className="popup popup_type_profile">
          <div className="popup__container">
            ...
            <form action="#" className="form" name="profile-form" noValidate>
              <input id="name-input" type="text" className="form__input" name="name" defaultValue="" minLength="2" maxLength="40"
                required />
              <span className="name-input-error form__input-error">Error</span>
              <input id="job-input" type="text" className="form__input" name="job" defaultValue="" minLength="2" maxLength="200"
                required />
        ...
        <div className="popup popup_type_place">
          <div className="popup__container">
            ...
            <form action="#" className="form" name="card-form" noValidate>
              <input id="title-input" type="text" className="form__input" name="name" placeholder="Название" defaultValue="" minLength="2" maxLength="30" required />
              <span className="title-input-error form__input-error">Error</span>
              <input id="url-input" type="url" className="form__input" name="url" placeholder="Ссылка на картинку" defaultValue="" required />
        ...
        <div className="popup popup_type_avatar">
          <div className="popup__container">
            ...
            <form action="#" className="form" name="avatar-form" noValidate>
              <input id="url-avatar-input" type="url" className="form__input" name="url" placeholder="Ссылка на картинку" defaultValue="" required />
